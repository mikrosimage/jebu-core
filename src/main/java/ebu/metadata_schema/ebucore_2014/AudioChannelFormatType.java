 ...
 *       &lt;sequence>
 *         &lt;element ref="{urn:ebu:metadata-schema:ebuCore_2014}frequency" maxOccurs="2" minOccurs="0"/>
 *         &lt;element ref="{urn:ebu:metadata-schema:ebuCore_2014}audioBlockFormat" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 ...
 *       &lt;attribute name="audioChannelFormatID" type="{http://www.w3.org/2001/XMLSchema}anyURI" />
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
 * </pre>
...
public class AudioChannelFormatType implements Comparable<AudioChannelFormatType>{

	/**
	 * Prefix for this type EBUCore String ID
	 */
	public static final java.lang.String PREFIX = "AC_";
    ...
    @Override
    public int compareTo(AudioChannelFormatType other) {
    	return other.getAudioChannelFormatID().compareTo(getAudioChannelFormatID());
    }
    
    @Override
    public java.lang.String toString() {
    	// TODO Auto-generated method stub
    	return getAudioChannelFormatID();
    }
    ...
    public Set<AudioBlockFormatType> getAudioBlockFormat() {
        if (audioBlockFormat == null) {
            audioBlockFormat = new HashSet<AudioBlockFormatType>();
        }
