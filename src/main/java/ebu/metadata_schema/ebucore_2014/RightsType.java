 ...
 *         &lt;element name="rightsHolder" type="{urn:ebu:metadata-schema:ebuCore_2014}entityType" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="exploitationIssues" type="{urn:ebu:metadata-schema:ebuCore_2014}elementType" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="copyrightStatement" type="{urn:ebu:metadata-schema:ebuCore_2014}elementType" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="coverage" type="{urn:ebu:metadata-schema:ebuCore_2014}coverageType" minOccurs="0"/>
 *         &lt;element name="rightsClearanceFlag" type="{http://www.w3.org/2001/XMLSchema}boolean" minOccurs="0"/>
 *         &lt;element name="disclaimer" type="{urn:ebu:metadata-schema:ebuCore_2014}elementType" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="rightsAttributedId" type="{urn:ebu:metadata-schema:ebuCore_2014}identifierType" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="contactDetails" type="{urn:ebu:metadata-schema:ebuCore_2014}contactDetailsType" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
...
public class RightsType {
    ...
    protected List<ebu.metadata_schema.ebucore_2014.ElementType> exploitationIssues;
    protected List<ebu.metadata_schema.ebucore_2014.ElementType> copyrightStatement;
    protected CoverageType coverage;
    protected java.lang.Boolean rightsClearanceFlag;
    protected List<ebu.metadata_schema.ebucore_2014.ElementType> disclaimer;
     ...
     * 
     */
    public List<ebu.metadata_schema.ebucore_2014.ElementType> getExploitationIssues() {
        if (exploitationIssues == null) {
            exploitationIssues = new ArrayList<ebu.metadata_schema.ebucore_2014.ElementType>();
        }
     ...
     * 
     */
    public List<ebu.metadata_schema.ebucore_2014.ElementType> getCopyrightStatement() {
        if (copyrightStatement == null) {
            copyrightStatement = new ArrayList<ebu.metadata_schema.ebucore_2014.ElementType>();
        }
     ...
     * 
     */
    public List<ebu.metadata_schema.ebucore_2014.ElementType> getDisclaimer() {
        if (disclaimer == null) {
            disclaimer = new ArrayList<ebu.metadata_schema.ebucore_2014.ElementType>();
        }
